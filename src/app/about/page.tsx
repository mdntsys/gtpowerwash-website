        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {traits.map((trait, idx) => (
              <div
                key={trait.label}
                className={`rounded-2xl border p-8 sm:p-10 ${trait.accent} flex flex-col sm:flex-row gap-6 sm:gap-10 items-start`}
              >
                ...
                <div>
                  <h3 className={`text-xl sm:text-2xl font-extrabold mb-3 ${trait.headingColor}`}>
                    {trait.heading}
                  </h3>
